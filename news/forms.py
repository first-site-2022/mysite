...
class ContactForm(forms.Form):
    subject = forms.CharField(max_length=150, label="Subject", widget=forms.TextInput(attrs={"class": "form-control"}))
...
class UserRegisterForm(UserCreationForm):
    ...
    password1 = forms.CharField(max_length=150, label="Enter password",
...
class NewsForm(forms.ModelForm):
    ...
    # category = forms.ModelChoiceField(empty_label="Choose the category ",queryset=Category.objects.all(),label="CATEGORY", widget=forms.Select(attrs={"class": "form-control"}))


class UserLoginForm(AuthenticationForm):
    username = forms.CharField(max_length=150, label="User name",
                               widget=forms.TextInput(attrs={"class": "form-control"}))
    password = forms.CharField(max_length=150, label="Enter password",
                               widget=forms.PasswordInput(attrs={"class": "form-control"}))
